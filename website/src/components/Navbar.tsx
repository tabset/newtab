    ...
    <nav className="navbar">
      <div className="navbar-inner container">
        ...
        <ul className="nav-links">
          ...
          <li>
            <a href="https://github.com/tabset/newtab" target="_blank" rel="noreferrer" className="nav-github">
        ...
        <a href="/#install" className="btn btn-primary nav-cta">Add to Chrome</a>
      </div>
    </nav>
  )
}
